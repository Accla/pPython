...
# this causes an error: TypeError: 'module' object is not callable
# CB: introduced a subdirectory, grid, to organized any metthods used for grid operations.
#     renamed grid directory to remote
#
g = proc_grid(X)
# The following works
# g = X.map['grid']
