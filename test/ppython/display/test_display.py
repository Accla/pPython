"""test_display.py
    Test pPython distributed array function, display()
    ...
    Output will be piped into two files:
        ...
        PythonMPI/test_display.0.out
        . . . 
        PythonMPI/test_display.3.out
...
# Case 1: display a Dmap object
print('\n1. display a Damp object.\n')
display(Amap)

X = rand(1,N,map=Amap)

# Case 2: display a Dmat object
print('\n2. display a Dmat object.\n')
display(X)
