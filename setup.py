...
setup(
    ...
    version='0.10.3',  # Required (GPU array special)
    ...
    # install_requires=['paramiko'],  # Optional
    install_requires=['multipledispatch', 'sympy'],  # Optional

    # List additional groups of dependencies here (e.g. development
    # dependencies). Users wiparamikoll be able to install these using the "extras"
    # syntax, for example:
    #
