"""basic_app3.py Basic example of a typical application for which 
    ...
    To run, start Matlab and type:
        ...
        MPI_Run('basic_app3',4,{})

    Or, to run a different machine type:

        MPI_Run('basic_app3',4,{'machine1' 'machine2' 'machine3' 'machine4'})
...
if (LeaderIsWorkerToo | (my_rank != leader)):
    ...
    for i in range(N2):
        ...
        if (my_rank == dest):
            ...
            print('Waiting on dest_tag: %d' %(dest_tag))
